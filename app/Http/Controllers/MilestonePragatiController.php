    ...
    public function report(Request $request){
        try {
            ...
            foreach($kaaryalayaIDs as $kaaryalayaID) {
                ...
                $milestonePragatis =  MilestonePragati::whereIn('milestone_lakshya_id',$milestoneLakshyaIDs)->where('kaaryalaya_id',$kaaryalayaID)->where('mahina_id',$mahinaID)->with(['kaaryalaya','milestoneLakshya'])->get();

                //data with summations
                $milestonePragatis = $milestonePragatis->map(function($item) use ($totalMahinaArray){
                    /* this will give all data upto that month */
                    $totalData = MilestonePragati::where('milestone_lakshya_id',$item['milestone_lakshya_id'])->where('kaaryalaya_id',$item['kaaryalaya_id'])->whereIn('mahina_id',$totalMahinaArray);
