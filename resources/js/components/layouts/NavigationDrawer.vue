            ...
            items: [
                ...
                },
                {
                    title: "फारम", icon: "mdi-note", subItems: [
                        ...
                        {title: 'माइलस्टोन प्रगती', icon: 'mdi-folder', route: '/kriyakalap-milestone-pragati', can:"milestone_pragati_form-browse"}
                    ]
                },
                {
                    title: "प्रतिवेदन", icon: "mdi-file-document", subItems: [
                        ...
                        {title: 'माइलस्टोन प्रगती प्रतिवेदन', icon: 'mdi-file-chart', route: '/kriyakalap-milestone-pragati-report', can: "milestone_pragati_report-browse"},
                    ]
                },
                {
